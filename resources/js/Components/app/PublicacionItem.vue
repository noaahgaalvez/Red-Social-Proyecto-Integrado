    ...
    <div class="flex flex-col gap-4 p-4 bg-white shadow rounded-md mb-3">
        ...
        <div class="grid grid-cols-3 gap-3">
            <template v-for="attachment in publicacion.attachments">
                ...
                <div class="bg-gray-200 aspect-square flex items-center justify-center text-gray-600 relative">
                    <button class="w-6 h-6 flex items-center justify-center text-white bg-gray-700 rounded absolute right-2 top-2 text-gray-400 cursor-pointer hover:bg-gray-800">
